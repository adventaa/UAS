...
@section('container')
<form method="post" action="/admin/buku" class="m-3">
    @csrf
    <div class="row mb-3">
        <label for="inputIsbn" class="col-sm-2 col-form-label">ISBN</label>
        <div class="col-sm-5">
          <input type="isbn" class="form-control" id="inputIsbn" name="isbn">
        </div>
      </div>
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-5">
        <input type="judul" class="form-control" id="inputJudul" name="judul">
      </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-5">
          <input type="tahun" class="form-control" id="inputTahun" name="tahun_terbit">
        </div>
      </div>
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-5">
        <input type="penulis" class="form-control" id="inputPenulis" name="penerbit">
      </div>
    </div>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-5">
            <select class="form-select" id="specificSizeSelect" name="kategori">
